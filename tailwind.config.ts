  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        accentBlue: "hsl(var(--primary))", // Re-map to primary as it's the same color
        accentRed: "hsl(var(--destructive))", // Re-map to destructive
        ...
        // Sidebar specific colors (matching existing structure)
        sidebar: {
